    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-emerald-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1 text-sm">Sign in to your nutrition dashboard</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <button onClick={handleGoogle}
            className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-2xl py-3 px-4 font-semibold text-gray-700 hover:bg-gray-50 transition-all mb-4">
